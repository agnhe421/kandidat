...
public class JoinServer extends Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            while(connected)
            {
                ...
                Gdx.app.log("strConv", "Data received. Message: " + strConv);
                Logger.get().print("Receiving: " + strConv.get(0), "msglog");
    ...
    private Vector<String> readData(BufferedInputStream bis, int readStatus, byte[] buff)
    {
        ...
        while(!allRead)
        {
            try
            {
                ...
                Logger.get().print("Number of bytes: " + readStatus, "msglog");
    ...
    {
        Logger.get().print("Sending check and data.", "errorlog");
        sendMessage(bos, "POS_DATA_INCOMING|" + data);
        Logger.get().print("Data sent.", "errorlog");
    }
