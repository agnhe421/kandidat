...
package com.qualcomm.vuforia.samples.libGDX.bullet;
...
public class BaseBulletTest extends BulletTest {
	...
	public void create () {
		...
		final Model boxModel = modelBuilder.createBox(10f, 10f, 10f, new Material(ColorAttribute.createDiffuse(Color.WHITE),
		...
		world.addConstructor("box", new BulletConstructor(boxModel, 3f)); // mass = 1kg: dynamic body
