...
public class CreateServerScreen implements Screen{
    ...
    public void render(float delta) {
        ...
        player.setText(app.font50, player1);

        GlyphLayout Server = new GlyphLayout();
        Server.setText(app.font50, player1);

        GlyphLayout glyphLayoutlist = new GlyphLayout();
        glyphLayoutlist.setText(app.font50, playerList);
        ...
        app.font50.draw(app.batch, serverName, x - fex, y + fey + 120);
        app.font50.draw(app.batch, player1, x - fmx, y + fmy + 50);
        app.font50.draw(app.batch, "Screen: createServer", 30, 30);
        app.font50.draw(app.batch, playerList, 75, y + fmy + 250);
