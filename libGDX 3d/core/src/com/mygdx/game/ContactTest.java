...
/**
 * Created by sofiekhullar on 16-04-04.
 */
public class ContactTest extends BaseBulletTest {
    ...
    public void create () {
        ...
        final Model sceneModel = objLoader.loadModel(Gdx.files.internal("ship.obj"));
        disposables.add(sceneModel);
        final BulletConstructor sceneConstructor = new BulletConstructor(sceneModel, 1f, new btBvhTriangleMeshShape(
                sceneModel.meshParts));
        sceneConstructor.bodyInfo.setRestitution(0.25f);
        world.addConstructor("scene", sceneConstructor);


        final BulletEntity scene = world.add("scene", 1,50f,0);
